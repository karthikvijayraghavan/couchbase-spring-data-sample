...
import com.cb.springdata.sample.SampleApplicationTests;
...
public class BuildingServiceIntegrationTest extends SampleApplicationTests {
	...
	public void testSave() {
		val building = new Building(BUILDING_1, "couchbase", COMPANY_2, new ArrayList<>(), new ArrayList<>());
	...
	public void testSaveWithMissingNameField() {
		val building = new Building("building::1", null, COMPANY_2, new ArrayList<>(), new ArrayList<>());
		buildingService.save(building);
	}

	@Test
	public void testFindByCompanyId() {
		val building = new Building(BUILDING_1, "building", COMPANY_2, new ArrayList<>(), new ArrayList<>());
		buildingService.save(building);
	...
	public void testFindByCompanyIdAndNameLike() {
		...
		val building2 = new Building("building::4", "AnotherBuilding", COMPANY_2, new ArrayList<>(), new ArrayList<>());
	...
	public void testFindArea2LevelsDeep() {
		...
		val areas = Arrays.asList(
				new Area("ref1", "ref1name", Arrays.asList(new Area(targetAreaId, "ref1ref1name", new ArrayList<>()))),
				new Area("ref2", "ref2name", new ArrayList<>()));
		val building1 = new Building(BUILDING_1, "couchbase", COMPANY_2, areas, new ArrayList<>());

		val areas2 = Arrays.asList(new Area("ref3", "ref3name", new ArrayList<>()),
				new Area("ref4", "ref4name", new ArrayList<>()));
		val building2 = new Building("buildingId::2", "couchbase manchester", "companyId::1", areas2,
				new ArrayList<>());
	...
	public void testFindPhoneNumber() {
		...
		val building = new Building(BUILDING_1, "building", COMPANY_2, new ArrayList<>(), Arrays
				.asList(targetPhoneNumber, "1-650-417-7500", "+1 (415) 963-4174", "1-650-417-7500", "1-650-964-7935"));
		buildingService.save(building);

		val building2 = new Building("building::3", "Some other building", COMPANY_2, new ArrayList<>(),
				Arrays.asList("+44 (0) 333 837 9130", "5-750-417-7500"));
		buildingService.save(building2);
	...
	public void testCount() {
		val building = new Building(BUILDING_1, "building1", COMPANY_2, new ArrayList<>(), new ArrayList<>());
		buildingService.save(building);

		val building2 = new Building("building::4", "building2", COMPANY_2, new ArrayList<>(), new ArrayList<>());
		buildingService.save(building2);

		val buildingFromOtherCompany = new Building("building::5", "buildingFromOtherCompany", "company::5",
